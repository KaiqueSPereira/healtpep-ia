...
// Correção: Definindo e exportando o tipo diretamente no arquivo
...
const AgendamentoItem = ({ agendamento }: AgendamentoItemProps) => {
  ...
  // O link agora aponta sempre para a rota de consulta, como planeado na refatoração
  const linkHref = `/consulta/${id}`;
  ...
  const tooltipContent = (
    <div className="p-2 text-sm">
      <p>
        <strong>Tipo:</strong> {tipoAgendamento}
      </p>
      {especialidade && (
        <p>
